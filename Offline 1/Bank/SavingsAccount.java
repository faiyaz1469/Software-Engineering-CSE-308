public class SavingsAccount extends Account {
    ...
    public SavingsAccount(String accountName, float initialDeposit) {
        super(accountName, initialDeposit);
        System.out.println("Savings account for " + accountName + " Created; initial balance " + initialDeposit +"$");
    }

    @Override
    public void withdrawMoney(float amount) {

        float netBalance = this.accountBalance - amount;
    ...
    public int requestLoan(float amount) {
        ...
        if(amount <= 10_000 && Bank.totalFund - amount > 0) {
